  ...
  const setupDemo = async () => {
    ...
    try {
      ...
      const { error: coursesError } = await supabase.from('courses').insert([
        { code: 'CSC101', title: 'Introduction to Computer Science', credit_hours: 3, level: 'ND1', semester: 'First' },
        { code: 'CSC102', title: 'Computer Programming I', credit_hours: 4, level: 'ND1', semester: 'First' },
        { code: 'MTH101', title: 'General Mathematics I', credit_hours: 3, level: 'ND1', semester: 'First' },
        { code: 'CSC103', title: 'Computer Programming II', credit_hours: 4, level: 'ND1', semester: 'Second' },
        { code: 'CSC104', title: 'Data Structures', credit_hours: 3, level: 'ND1', semester: 'Second' },
        { code: 'MTH102', title: 'General Mathematics II', credit_hours: 3, level: 'ND1', semester: 'Second' },
        { code: 'CSC201', title: 'Database Management Systems', credit_hours: 4, level: 'ND2', semester: 'First' },
        { code: 'CSC202', title: 'Web Technologies', credit_hours: 3, level: 'ND2', semester: 'First' },
        { code: 'CSC203', title: 'Operating Systems', credit_hours: 3, level: 'ND2', semester: 'First' },
        { code: 'CSC204', title: 'Software Engineering', credit_hours: 4, level: 'ND2', semester: 'Second' },
        { code: 'CSC205', title: 'Network Fundamentals', credit_hours: 3, level: 'ND2', semester: 'Second' },
        { code: 'CSC206', title: 'Project', credit_hours: 6, level: 'ND2', semester: 'Second' }
      ]);
      ...
      const { error: feeError } = await supabase.from('fee_payments').insert([
        { student_id: student1Data.id, semester: 'First', session: '2024/2025', amount_due: 50000.00, amount_paid: 50000.00, payment_date: new Date().toISOString(), status: 'paid' },
        { student_id: student1Data.id, semester: 'Second', session: '2024/2025', amount_due: 50000.00, amount_paid: 50000.00, payment_date: new Date().toISOString(), status: 'paid' },
        { student_id: student2Data.id, semester: 'First', session: '2023/2024', amount_due: 50000.00, amount_paid: 0, payment_date: null, status: 'unpaid' }
      ]);
      ...
      const csc101 = courses?.find(c => c.code === 'CSC101');
      const csc102 = courses?.find(c => c.code === 'CSC102');
      const mth101 = courses?.find(c => c.code === 'MTH101');
      const csc201 = courses?.find(c => c.code === 'CSC201');
      const csc202 = courses?.find(c => c.code === 'CSC202');
      const csc203 = courses?.find(c => c.code === 'CSC203');

      const { error: resultsError } = await supabase.from('results').insert([
        { student_id: student1Data.id, course_id: csc101?.id, semester: 'First', session: '2024/2025', ca_score: 25, exam_score: 50, total_score: 75, grade: 'A', grade_point: 5 },
        { student_id: student1Data.id, course_id: csc102?.id, semester: 'First', session: '2024/2025', ca_score: 22, exam_score: 46, total_score: 68, grade: 'B', grade_point: 4 },
        { student_id: student1Data.id, course_id: mth101?.id, semester: 'First', session: '2024/2025', ca_score: 28, exam_score: 54, total_score: 82, grade: 'A', grade_point: 5 },
        { student_id: student2Data.id, course_id: csc201?.id, semester: 'First', session: '2023/2024', ca_score: 15, exam_score: 20, total_score: 35, grade: 'F', grade_point: 0 },
        { student_id: student2Data.id, course_id: csc202?.id, semester: 'First', session: '2023/2024', ca_score: 24, exam_score: 46, total_score: 70, grade: 'B', grade_point: 4 },
        { student_id: student2Data.id, course_id: csc203?.id, semester: 'First', session: '2023/2024', ca_score: 22, exam_score: 43, total_score: 65, grade: 'C', grade_point: 3 }
      ]);
